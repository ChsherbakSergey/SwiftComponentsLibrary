...
final class StrokeProgressBarContentView: UIView {
    ...
    let progressView: StrokeProgressBarView = {
        let this = StrokeProgressBarView()
        this.translatesAutoresizingMaskIntoConstraints = false
        return this
    }()
    ...
    let borderTintColorLabel: UILabel = {
        let this = UILabel()
        this.translatesAutoresizingMaskIntoConstraints = false
        this.text = "Border Tint Color:"
        this.textColor = .label
        this.font = .systemFont(ofSize: 13, weight: .medium)
        return this
    }()

    let borderTintColorSegmentedControl: UISegmentedControl = {
        let this = UISegmentedControl()
        this.insertSegment(withTitle: "System Blue", at: 0, animated: false)
        this.insertSegment(withTitle: "System Green", at: 1, animated: false)
        this.insertSegment(withTitle: "System Indigo", at: 2, animated: false)
    ...
    private let borderTintColorStackView: UIStackView = {
        let this = UIStackView()
        this.axis = .vertical
        this.spacing = 8
        return this
    ...
    let borderWidthLabel: UILabel = {
        let this = UILabel()
        this.translatesAutoresizingMaskIntoConstraints = false
        this.text = "Border Width: 1.0"
        this.textColor = .label
        this.font = .systemFont(ofSize: 13, weight: .medium)
        return this
    }()

    let borderWidthSlider: UISlider = {
        let this = UISlider()
        this.translatesAutoresizingMaskIntoConstraints = false
        this.minimumValue = 1
        this.maximumValue = 5
    ...
    private func setupSubviews() {
        ...
        borderTintColorStackView.addArrangedSubview(borderTintColorLabel)
        borderTintColorStackView.addArrangedSubview(borderTintColorSegmentedControl)
        borderWidthStackView.addArrangedSubview(borderWidthLabel)
        borderWidthStackView.addArrangedSubview(borderWidthSlider)
        ...
        verticalStackView.addArrangedSubview(borderTintColorStackView)
        verticalStackView.addArrangedSubview(borderWidthStackView)
