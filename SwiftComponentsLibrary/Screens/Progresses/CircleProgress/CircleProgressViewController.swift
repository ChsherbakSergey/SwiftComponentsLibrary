...
final class CircleProgressViewController: UIViewController {

    // MARK: - Properties

    private let contentView = CircleProgressContentView()

    // MARK: - Init

    init() {
        super.init(nibName: nil, bundle: nil)
        title = "CircleProgressView"
    }
    ...
    @objc private func widthSliderValueDidChange(_ sender: UISlider) {
        ...
        contentView.progressView.width = roundedValue
    }
